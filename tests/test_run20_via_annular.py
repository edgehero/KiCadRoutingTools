...
ov = overrides('via_diameter = 0.3\nvia_drill = 0.3\nannular = 0.05\n', 'declared.txt')
check('a declared annular sets the pin target',
...
check('_MIN_SHIPPED_RING is derived from the tables, not hardcoded',
      abs(FT._MIN_SHIPPED_RING - 0.05) < 1e-9, str(FT._MIN_SHIPPED_RING))
